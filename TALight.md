...
Actually, it could be even better and more stimulating to have teams comprising a teacher proposing a set of competences to cover (competences he wants to transmit and believes could be interesting to decompose and boil down to problems suitable to be posed as challenges) and a group of students in the role of problem-makers and designers.  
...
As usual, we will achieve the highest of our results when pretending to be doing something else.
